import { onQuantitiyChange, removeFromCart } from "./cart.js";
    ...
    .map(
      (product) => `<div class="product">
          ...
          <div class="product-info">
            <h2>${product.title}</h2>
            <p>$${product.price}</p>
            <a data-id="${product.id}" href="#" class="add-to-cart">Add to cart</a>
          </div>
        </div>
  `
    )
...
`;
  ...
  const quantityInput = document.querySelectorAll(".cart-item-quantity");
